...
public class TemplateItemDataList {
    ...
    * @param answers a set of answers for the set of templateItems, this should be the complete
   ...
   protected void buildDataStructure() {
      ...
      // create the answersMap for the answers
      answersMap = makeItemKeyAnswersMap(answers);
   ...
   public class DataTemplateItem {
      ...
      public List<EvalAnswer> getAnswers() {
         ...
         if (TemplateItemUtils.isAnswerable(this.templateItem)) {
            String key = TemplateItemUtils.makeTemplateItemAnswerKey(this.templateItem.getId(), this.associateType, this.associateId);
   ...
   /**
    * Build a map using the answer key using this set of answers,
    * the order of the answers inside the lists is effectively random
    * 
    * @param answers a collection of answers
    * @return a map of item answer keys -> lists of related answers
    */
   private Map<String, List<EvalAnswer>> makeItemKeyAnswersMap(Collection<EvalAnswer> answers) {
      Map<String, List<EvalAnswer>> map = new HashMap<String, List<EvalAnswer>>();
