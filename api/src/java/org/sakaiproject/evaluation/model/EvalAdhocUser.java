...
public class EvalAdhocUser implements java.io.Serializable {
   ...
   /**
    * Get the id from the adhoc userId,
    * return null if the id cannot be found
    * 
    * @param userId the internal userId for this adhoc user
   ...
   /**
    * @return the internal userId for this adhoc user (will be null if the id is null),
   ...
   /**
    * The type of this user, use {@link #TYPE_EVALUATEE} (instructor) or {@link #TYPE_EVALUATOR} (student/participant)
    */
   protected String type;
   /**
    * The email address for this user if they have one,
    * this MUST be set for all adhoc users
    */
    ...
    * null if no display name is set
    */
    ...
    * @param email
    */
   public EvalAdhocUser(String owner, String type, String email) {
    ...
    * @param displayName
    */
   public EvalAdhocUser(String owner, String type, String email, String username, String displayName) {
      if (this.lastModified == null) { this.lastModified = new Date(); }
      this.owner = owner;
      this.type = type;
