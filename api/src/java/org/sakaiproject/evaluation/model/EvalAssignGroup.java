...
/**
 * This is the assignment of a group to an evaluation and is how we know that the
 * group should be taking an eval<br/>
 * <b>NOTE:</b> the nodeId will be set to the id of the node which caused this group to be added
 * if it was added that way, it will be null if the group was assigned directly
 */
