...
public class RenderingUtilsTest {
    ...
    public void testGetMatrixLabels() {
    	List<String> scaleOptions0 = new ArrayList<String>(Arrays.asList("a", "b"));
    	...
    	List<String> scaleOptions1 = new ArrayList<String>(Arrays.asList("a", "b", "c"));
    	...
    	List<String> scaleOptions2 = new ArrayList<String>(Arrays.asList("a", "b", "c", "d"));
    	...
    	List<String> scaleOptions3 = new ArrayList<String>(Arrays.asList("a", "b", "c", "d", "e"));
    	...
    	List<String> scaleOptions4 = new ArrayList<String>(Arrays.asList("a", "b", "c", "d", "e", "f"));
    	...
    	List<String> scaleOptions5 = new ArrayList<String>(Arrays.asList("a", "b", "c", "d", "e", "f", "g"));
