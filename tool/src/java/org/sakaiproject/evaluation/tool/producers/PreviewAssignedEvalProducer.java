 ...
 * $URL: https://source.sakaiproject.org/contrib/evaluation/branches/CT-623/tool/src/java/org/sakaiproject/evaluation/tool/producers/TakeEvalProducer.java $
 * $Id: TakeEvalProducer.java 52081 2008-08-17 19:53:20Z rwellis@umich.edu $
 **************************************************************************
 ...
 */
public class PreviewAssignedEvalProducer implements ViewComponentProducer, ViewParamsReporter, NavigationCaseReporter, ActionResultInterceptor {

   private static Log log = LogFactory.getLog(PreviewAssignedEvalProducer.class);

   public static final String VIEW_ID = "preview_assigned_eval";
