 ...
 */
public class ExpertCategoryProducer implements ViewComponentProducer, NavigationCaseReporter, ViewParamsReporter {
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
		...
		eivp.viewID = SummaryProducer.VIEW_ID; // TODO - WRONG, set to right view

		// loop through all expert categories
		...
		for (int i = 0; i < expertCategories.size(); i++) {
			...
			UIOutput.make(categories, "category-description", category.getTitle()); //$NON-NLS-1$
		}
