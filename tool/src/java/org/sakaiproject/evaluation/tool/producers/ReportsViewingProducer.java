    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        if (reportParams.evaluationId != null) {
            ...
            UIInternalLink.make(tofill, "report-groups-title", UIMessage.make("reportgroups.page.title"), 
                    new TemplateViewParameters(ReportChooseGroupsProducer.VIEW_ID, reportParams.evaluationId));
            ...
            if (! allItems.isEmpty()) {
                ...
                UIInternalLink.make(tofill, "fullEssayResponse", UIMessage.make("viewreport.view.essays"), 
                        new EssayResponseParams(ReportsViewEssaysProducer.VIEW_ID, reportParams.evaluationId, groupIds));
...
//      if (myItem.getClassification().equals(EvalConstants.ITEM_TYPE_SCALED)) { //"Scaled/Survey"
        if(TemplateItemUtils.getTemplateItemType(myTempItem).equals(EvalConstants.ITEM_TYPE_SCALED)){
            ...
            UIInternalLink.make(essay, "essayResponse", new EssayResponseParams(ReportsViewEssaysProducer.VIEW_ID, evalId, myTempItem.getId(), groupIds));
