...
public class PDFReportExporter implements ReportExporter {
    ...
    private void renderDataTemplateItem(EvalPDFReportBuilder evalPDFReportBuilder, DataTemplateItem dti) {
        ...
        if (EvalConstants.ITEM_TYPE_HEADER.equals(templateItemType)) {
            ...
            int[] responseArray = TemplateItemDataList.getAnswerChoicesCounts(templateItemType, itemScaleOptions.length, itemAnswers);
            ...
            if (dti.usesComments()) {
                ...
                evalPDFReportBuilder.addCommentList(messageLocator.getMessage("viewreport.comments.header"), 
                        comments, messageLocator.getMessage("viewreport.no.comments"));
            }
