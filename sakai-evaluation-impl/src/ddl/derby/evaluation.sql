...
--
    ...
    create table EVAL_ASSIGN_GROUP (
        ...
        INSTRUCTORS_VIEW_ALL_RESULTS smallint,
    ...
    create table EVAL_EVALUATION (
        ...
        INSTRUCTOR_VIEW_ALL_RESULTS smallint default null,
        ...
        TERM_ID varchar(255),
        AVAILABLE_EMAIL_SENT smallint default 0,
        ...
        ALL_ROLES_PARTICIPATE smallint,
        SECTION_AWARE smallint,
        ...
        SELECTION_SETTINGS varchar(2000),
        EMAIL_OPEN_NOTIFICATION smallint,
